...
| ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- |
| - km<br>- emision bus por km<br>- emision auto por km | - emisiones totales recorrido bus = km × emision bus por km<br>- emisiones totales recorrido auto = km × emision bus por km<br>- comparar si emisiones totales recorrido bus es mayor o menor a emisiones totales recorrido auto | vehículo de menor emisión |
...
| input                                                      | process                                                                      | output                                   |
| ---------------------------------------------------------- | ---------------------------------------------------------------------------- | ---------------------------------------- |
| - lectura anterior<br>- lectura actual<br>- tarifa mensual | restar lectura actual con lectura anterior<br>coste = tarifa mensual x resta | resta (es la cantidad de $m^3$)<br>coste |
