...
Está en los compus, pero si quieren probar en sus casas deben instalarlo.
...
¿Qué pasa si solo escriben "Hello World" y ejecutan?
...
Pueden asignarle a varias variables un mismo valor usando:

x = y = z = 10

o asignar valores a variables variables en una misma línea usando ",":
...
usualmente son 4 espacios.

¿Qué pasa si no colocamos la identación?
...
Todo lo que va después del # en la misma línea, será considerado comentario.

---

Podemos hacer un bloque de comentarios usando 3 " o ':
...
1.  Haz un algoritmo que pida el precio, pago y entregue el vuelto.
