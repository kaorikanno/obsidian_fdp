...
- [ ] Buenas prácticas a la hora de escribir pseudocódigo
...
Si quieren practicar: https://psintplus.lat/
...
---
> Problema:
   Dar instrucciones para lavar una taza.
...
2. Calcular la distancia total recorrida en 7 tramos
...
3. mostrar precio
4. leer dinero ingresado
5. si dinero = precio:
6.   entregar producto
7. si dinero es mayor al precio:
8.    vuelto = dinero - precio
9.   entregar producto seleccionado y vuelto
10. en otro caso:
11.   mostrar mensaje de error

---

En https://psintplus.lat/

Proceso Exp

    Definir nombre_producto Como Cadena
    Definir precio_producto, dinero Como Entero
    ...
    Escribir nombre_producto, "Precio del producto es: ", precio_producto

    Escribir "Ingresar dinero del cliente:"
    Leer dinero

    Si dinero = precio_producto Entonces
        Escribir "Entregar producto"
    Sino
        Si dinero > precio_producto Entonces
            Escribir "vuelto es: ", dinero - precio_producto
            Escribir "Entregando producto y vuelto..."
        Sino
...
1. Identifique al menos **2 pasos irrelevantes o demasiado específicos**, e indicar porqué los catalogaron así.
...
No traten de meter muchas instrucciones en una misma línea:
...
1. Escribe el paso a paso de cómo armar 3 sándwiches deliciosos, con al menos 6 pasos y 5 ingredientes cada uno, especificando también el tipo de pan, si hay que calentarlo o no, y si hay que freír o no o cocinar cualquier ingrediente.
...
| paso 3 |            |            |            |
|        |            |            |            |
2. Piensa en qué ocurre si tu proveedor de algún ingrediente falla justo antes de la clase, ¿Cómo reemplazarías el ingrediente?
...
2. Redacta el pseudocódigo del proceso HacerSandwich(), que englobe el poder elegir hacer cualquiera de estos sándwiches.
