...
| Entrada:             | Proceso:                                                                                  | Salida                 |
| -------------------- | ----------------------------------------------------------------------------------------- | ---------------------- |
| - N1<br>- N2<br>- N3 | - N_total = N1 + N2 + N3<br>-  x = $N\_total/3$<br>- analizar si x es mayor o menor a 4.0 | - Aprobado o reprobado |
...
Problema: Hacer matriz IPO del proceso de revisar si una persona puede votar o no. Fijarse en:
...
| Entrada:                      | Proceso:                                                 | Salida             |
| ----------------------------- | -------------------------------------------------------- | ------------------ |
| - edad<br>- año de elecciones | - revisar si es año de elecciones<br>- revisar edad > 18 | - puede votar o no |
